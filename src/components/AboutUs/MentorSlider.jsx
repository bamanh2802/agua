const mentors = [
    {
      ...
      name: "Ms. Thi Hoang",
      title: "Mentor",
      quote: '"I believe it is important to give everyone the opportunity to explore all the possibilities: you are capable of more than you might think"',
    ...
    },
    {
      ...
      name: "Ms. Tuongvan Le ",
      title: "Mentor",
      quote: '"Ive always been a curious person. When I started college, I wondered: What would my life have been like if I had grown up in Vietnam? The best way to find out was to meet peers my age who had."',
    ...
    return (
      <div className="bg-white py-5 px-3">
        <div className="container text-center">
          <h2 style={{ color: '#0074b4' }} className="fw-bold">Our Mentor</h2>
        </div>
            ...
            {mentors.map((mentor, index) => (
              <div key={index} className={`carousel-item ${index === 0 ? 'active' : ''}`}>
                <div className="d-flex flex-column align-items-center text-center">
                  ...
                  <h3 className="mt-3" style={{ color: '#0074b4' }}>
                    {mentor.name} - {mentor.title} 
                    <a href={mentor.linkedin} target="_blank" rel="noopener noreferrer" className="ms-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0A66C2" className="bi bi-linkedin" viewBox="0 0 16 16">
